            ...
            <div class="w3_footer_grid_bottom">
                ...
                <ul class="w3_footer_grid_list">
                    <li>Фирменный стиль
                            ...
                            Для корректного отображения фирменных элементов компании предлагаем воспользоваться оригинальными файлами:</li>
                    <li>Время работы

                            С 8:30 до 17:15, кроме выходных.</li>
                    <li>Контакты для средств массовой информации
