...
<header class="main-header">
        ...
        <h3><a href="<?= Url::home()?>"><span class="fab fa-accusoft"></span>Лого Дом</a></h3>
    ...
    echo Nav::widget([
        ...
        'items' => [
            ...
            ['label' => 'Статистика', 'url' => ['/statistics/stat/index']],
            ...
            ['label' => 'Метки', 'url' => ['/admin/tag/index']],

            Yii::$app->user->isGuest ? (
            ['label' => 'Login', 'url' => ['/auth/login']]
            ) : (
                '<li><div style="margin-top: 0.5em;">'
                . Html::beginForm(['/auth/logout'], 'post',[
//                        'class' => 'logout-btn-admin',
                ])
                . Html::submitButton(
