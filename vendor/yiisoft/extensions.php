...
return array (
  ...
  'phpnt/animate-css' => 
  array (
    'name' => 'phpnt/animate-css',
    'version' => '0.0.1.0',
    'alias' => 
    array (
      '@phpnt/animateCss' => $vendorDir . '/phpnt/animate-css',
    ),
  ),
  'phpnt/bootstrap-notify' => 
  array (
    'name' => 'phpnt/bootstrap-notify',
    'version' => '0.0.2.0',
    'alias' => 
    array (
      '@phpnt/bootstrapNotify' => $vendorDir . '/phpnt/bootstrap-notify',
    ),
  ),
  'phpnt/bootstrap-select' => 
  array (
    'name' => 'phpnt/bootstrap-select',
    'version' => '0.0.1.0',
    'alias' => 
    array (
      '@phpnt/bootstrapSelect' => $vendorDir . '/phpnt/bootstrap-select',
    ),
  ),
  ...
  array (
    ...
    'alias' => 
    array (
      '@boundstate/mailgun' => $vendorDir . '/boundstate/yii2-mailgun/src',
    ),
  ),
  ...
  'phpnt/admin-lte' => 
  array (
    'name' => 'phpnt/admin-lte',
    'version' => '0.0.2.0',
    'alias' => 
    array (
      '@phpnt/adminLTE' => $vendorDir . '/phpnt/admin-lte',
    ),
  ),
  'phpnt/yii2-metismenu' => 
  array (
    'name' => 'phpnt/yii2-metismenu',
    'version' => '0.0.3.0',
    'alias' => 
    array (
      '@phpnt/metismenu' => $vendorDir . '/phpnt/yii2-metismenu',
    ),
  ),
