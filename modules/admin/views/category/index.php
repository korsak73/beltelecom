...
use app\common\helpers\CategoryHelper;
...
<div class="categories-index">
    ...
    $gridColumns = [
        ...
        [
            'attribute' => 'status',
            'filter'     =>  CategoryHelper::statusList(),
            'format' => 'raw',
            'value' => function (Categories $model) {
                /* @var $model app\models\Categories */
                return CategoryHelper::statusLabel($model->status);
            },
        ...
        [
            ...
            'filter' => false,
            'value' => function (Categories $model) {
                return CategoryHelper::change($model);
            }
        ],
        [
...
//                            'data-method' => 'post',
            ...
            'urlCreator' => function($action, $model, $key, $index) {
                if ($action == 'update' ) {
                    return Url::toRoute(['/admin/category/update', 'id' => $key]);
                }
                if ($action == 'delete' ) {
                    return Url::toRoute(['/admin/category/delete', 'id' => $key]);
                }
            },
        ],
    ];
